  ...
  return (
    <div className="portfolio--section">
      ...
      {/* <div className="portfolio--container-box">
        ...
        <div>
          <a href="https://github.com/peterzorve" target="_blank">
      ...
      <div className="portfolio--section--container">
          ...
          <div className="portfolio--section--card">
            ...
            <div className="portfolio--section--card--content">
              <div>
                <h3 className="portfolio--section--title">Diabetes Detection</h3>
                <p> 
                This straightforward machine learning model is trained to predict the likelihood of a person having diabetes based on variables such as glucose level, blood pressure, skin thickness, and insulin levels. The model is trained using six different algorithms: Logistic Regression, Decision Tree Classifier, Linear SVC, SVC, Random Forest Classifier, and Gradient Boosting Classifier.
                </p>
              </div>
              <a href="https://github.com/peterzorve/2.2.__ML_Project__Diabetes_Detection/blob/main/train_models.ipynb" target="_blank">
                <p className="text-sm portfolio--link">
          ...
          <div className="portfolio--section--card">
            ...
            <div className="portfolio--section--card--content">
              <div>
                <h3 className="portfolio--section--title">Generalized Machine Learning Predictor</h3>
                <p> 
                  This machine learning model is designed to train and make predictions using any uploaded .csv or Excel file. Users do not need to worry about data preprocessing or other requirements before training.
                  After uploading the file, the user simply specifies the property (target) to be predicted. The training process then employs the following models:
              ...
              <a href="https://github.com/peterzorve/project-generalized-machine-learning-predictor/blob/main/training_model.ipynb" target="_blank">
                <p className="text-sm portfolio--link">
                Source code in Github
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 20 19" fill="none">
                      <path d="M4.66667 1.66675H18V15.0001M18 1.66675L2 17.6667L18 1.66675Z" stroke="currentColor" stroke-width="2.66667" stroke-linecap="round" stroke-linejoin="round"/>
          ...
          {/* <div className="portfolio--section--card">
            ...
            <div className="portfolio--section--card--content">
              <div>
                <h3 className="portfolio--section--title">Cancer Prediction Model </h3>
                <p> 
                FashionMNIST classification is a deep learning task focused on categorizing images of clothing and accessories into one of 10 categories: T-shirts, trousers, pullovers, dresses, coats, sandals, shirts, sneakers, bags, and ankle boots. The objective is to create a model capable of accurately identifying the type of apparel in each image, which can enhance computer vision applications in the fashion and retail industries.
                </p>
              </div>
              <a href="https://github.com/peterzorve/deep-learning-fashion-mnist/blob/main/training.ipynb" target="_blank">
                <p className="text-sm portfolio--link">
                Source code in Github
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 20 19" fill="none">
                      <path d="M4.66667 1.66675H18V15.0001M18 1.66675L2 17.6667L18 1.66675Z" stroke="currentColor" stroke-width="2.66667" stroke-linecap="round" stroke-linejoin="round"/>
          ...
          {/* <div key={1} className="portfolio--section--card">
            <div className="portfolio--section--img">
              <img src={img_1} alt="Placeholder" />
            </div>
            <div className="portfolio--section--card--content">
