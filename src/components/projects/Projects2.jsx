    ...
    <div className="portfolio--section">
      ...
      <div className="portfolio--section--container">
          ...
          <div className="portfolio--section--card">
            ...
            <div className="portfolio--section--card--content">
              <div>
                <h3 className="portfolio--section--title">Toxic Comment Classification (TCC)</h3>
                <p> This is a ML model model trained to predict whether any given comment falls into one of the following categories
              ...
              <a href="https://github.com/peterzorve/deep-learning-toxic-comment-classification/blob/main/classification.ipynb" target="_blank">
                <p className="text-sm portfolio--link">
          ...
          <div className="portfolio--section--card">
            ...
            <div className="portfolio--section--card--content">
              <div>
                <h3 className="portfolio--section--title">Text & Document Summarizer (TDS)</h3>
                <p> This is a Deep Learning model trained to summarize and provide the wordcloud image of any lengthy document (such as blogs, articles, etc ).
                    This gives the reader an idea of the document before deciding whether to read the whole document. The length of the summary is provided by the user (default value is 30%).
                </p>
              </div>
              <a href="https://github.com/peterzorve/Text-Document-Summarizer/blob/main/application.ipynb" target="_blank">
                <p className="text-sm portfolio--link">
                Source code in Github
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 20 19" fill="none">
                      <path d="M4.66667 1.66675H18V15.0001M18 1.66675L2 17.6667L18 1.66675Z" stroke="currentColor" stroke-width="2.66667" stroke-linecap="round" stroke-linejoin="round"/>
          ...
          <div className="portfolio--section--card">
            ...
            <div className="portfolio--section--card--content">
              <div>
                <h3 className="portfolio--section--title">FashionMNIST Classifier</h3>
                <p> 
